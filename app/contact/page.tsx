...
export const metadata: Metadata = {
  title: "Contact Us | Mangalam Vastu Customer & Expert Support",
  description:
    "Get in touch with the Mangalam Vastu support team. Reach us for general inquiries, technical assistance, astrologer registrations, and Vastu partnerships.",
  alternates: {
  ...
  openGraph: {
    title: "Contact Us | Mangalam Vastu Customer & Expert Support",
    description:
      "Get in touch with the Mangalam Vastu team for technical support, partnership inquiries, or astrologer registrations.",
...
export default function ContactPage() {
  ...
  const contactPageSchema = {
    ...
    "@type": "ContactPage",
    name: "Contact Mangalam Vastu",
    description: "Official contact channel for Mangalam Vastu AI platform inquiries and support.",
    url: `${SITE_URL}/contact`,
    mainEntity: {
      "@type": "Organization",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            ...
            <div className="glass p-8 rounded-[2rem] border border-white">
              ...
              <h2 className="text-xl font-cormorant font-bold italic text-primary mb-2">
                Office Address
              </h2>
